        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="CustomerID" value="{{ $customer->CustomerID }}" class="form-control"
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="CompanyName" value="{{ $customer->CompanyName }}" class="form-control"
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="ContactTitle" value="{{ $customer->ContactTitle }}" class="form-control"
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="Region" value="{{ $customer->Region }}" class="form-control" placeholder="Region">
                    @error('Region')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="PostalCode" value="{{ $customer->PostalCode }}" class="form-control" placeholder="Postal Code">
                    @error('PostalCode')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
