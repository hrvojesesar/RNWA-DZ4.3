...
<head>
    <meta charset="UTF-8">
    <title>Add Employee Territory</title>
...
<div class="container mt-2">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left mb-2">
                <h2>Add Employee Territory</h2>
            </div>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('employee_territories.index') }}"> Back</a>
            </div>
        </div>
    </div>
    @if(session('status'))
    ...
    @endif
    <form action="{{ route('employee_territories.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
