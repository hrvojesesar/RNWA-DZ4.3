        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="UnitsOnOrder" class="form-control" placeholder="Units On Order">
                    @error('UnitsOnOrder')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="ReorderLevel" class="form-control" placeholder="Reorder Level">
                    @error('ReorderLevel')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="Discontinued" class="form-control" placeholder="Discontinued">
                    @error('Discontinued')
                    <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
